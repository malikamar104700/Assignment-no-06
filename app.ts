...
var sum:number= parseInt(prompt("find sum of all natural numbers"))
var sum1:number=1
var sum2:number=0
while(sum1<=sum){ 
    sum2 +=sum1
...
var even :number=parseInt(prompt("find sum of all even numbers"))
var even1:number=1
var even2:number=0
while(even1<=even){
    if(even1%2==0){
...
var odd:number=parseInt(prompt("find sum of all odd numbers "))
var odd1:number=1
var odd2:number=0
while(odd1<=odd){
    if(odd1%2==1){
...
var table:number=parseInt(prompt("enter number to write table"))
var table2:number=parseInt(prompt("enter length of table "))
var table1:number=1
while (table1<=table2) {
...
var digit1:number=parseInt(prompt("enter number to find sum of first and last digit"))
...
// var a1:number=26
// console.log(a+a1)
var digit2:number=digit1
var digit3:number=digit1%10
while (digit2>=10) {
    digit2=(digit2/10)
